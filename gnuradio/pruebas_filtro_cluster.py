...
class pruebas_filtro_cluster(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.customModule_filtro_FIR_cluster_0_2 = customModule.filtro_FIR_cluster([-0.000159218610761937911200758488661222145,-0.000430359456204313154097790272700763126,
        ...
        -0.010006147282870192505299655749695375562,-0.003488248846301648335016531987662347092, 0.003184140060691302911988209700666629942, 0.007608160734253766391277373770662961761,
        ...
        -0.000430359456204313154097790272700763126,-0.000159218610761937911200758488661222145], 2)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_noise_source_x_0_0, 0), (self.customModule_filtro_FIR_cluster_0_2, 0))
        self.connect((self.customModule_filtro_FIR_cluster_0_2, 0), (self.qtgui_freq_sink_x_0_0, 0))
